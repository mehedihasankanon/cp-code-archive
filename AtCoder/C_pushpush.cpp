...
// link    : https://atcoder.jp/contests/abc066/tasks/arc077_a
// status  : ac both algo
...
{   
    ...
    /*if(n%2==0) forn(i,n)
    {
        if(i%2==0) cin >> v[n/2+i/2];
        else cin >> v[n/2-(i+1)/2];
    }
    else forn(i,n)
    {
        if(i%2==0) cin >> v[n/2-i/2];
    ...
    if(n%2==0)
    {
        for(ll i = n-1; i >= 1; i-=2) cout << v[i] << " ";
        for(ll i = 0; i <= n-1; i+=2) cout << v[i] << " ";
    }
    else
    {
        for(ll i = n-1; i >= 0; i-=2) cout << v[i] << " ";
        for(ll i = 1; i <= n-1; i+=2) cout << v[i] << " ";
    }
